    ...
    return (
        <FormContainer>
            ...
            <AddressRow>
                ...
                <Button onClick={() => handlePostcodePopup("departure")}>
                    검색
                </Button>
            </AddressRow>
            ...
            <AddressRow>
                ...
                <Button onClick={() => handlePostcodePopup("arrival")}>
                    검색
                </Button>
            </AddressRow>
                ...
                <>
                    ...
                    <SummaryBox>
                        ...
                        <div>
                            ...
                            <LineValue>{`${AVERAGE_PRICE_PER_KM.toLocaleString(
                                "ko-KR"
                            )}원/km`}</LineValue>
                        </div>
...
const Input = styled.input`
    ...
    background-color: ${(props) =>
        props.value && props.value !== "" ? "#ffffff" : "#f5f5f5"};
    outline: none;
    &:focus {
