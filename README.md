...
> 화물주와 차주 간의 운송 주문을 연결하고 효율적으로 관리하기 위한 플랫폼입니다. 실시간 운송 추적, 정산 시스템, 그리고 사용자 및 관리자 간의 원활한 소통을 지원합니다.
...
| 이름   | 역할                               | GitHub               |
| ------ | ---------------------------------- | -------------------- |
| 나은별 | Fullstack Developer (오더/지도 API/거래 시스템) | [GitHub 프로필 링크] |
| 방성남 | Fullstack Developer (차주 마이페이지/정산 시스템) | [GitHub 프로필 링크] |
| 손민우 | Fullstack Developer (PM/DevOps/관리자/실시간 채팅) | [GitHub 프로필 링크] |
| 이동신 | Fullstack Developer (메인/회원/소셜 로그인) | [GitHub 프로필 링크] |
| 최재형 | Fullstack Developer (화물주 마이페이지/결제 시스템) | [GitHub 프로필 링크] |
...
-   **Frontend:**
    ...
    -   ![React Router](https://img.io/badge/React_Router-CA4245?style=for-the-badge&logo=react-router&logoColor=white)
...
-   **DevOps & Collaboration:**
    ...
    -   ![ERD Cloud](https://img.shields.io/badge/ERD_Cloud-4285F4?style=for-the-badge&logo=google-cloud&logoColor=white) (Using Google Cloud logo as a placeholder for ERD Cloud, as no specific badge exists)
