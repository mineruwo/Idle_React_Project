...
const Footer = () => {
    ...
    const { moveToAdminPage, moveToWebSocketTestPage } = useCustomMove();

    return (
        <footer className="bg-dark text-white py-4 mt-5">
            <div className="container text-center">
                <p className="mb-1 fw-bold">핑크 성남운송</p>
                ...
                <div>
                    ...
                    <button onClick={moveToWebSocketTestPage}>웹소켓 테스트 페이지</button>
                </div>
            </div>
        </footer>
    );
