            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown" data-bs-theme="light">
                            <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="#" id="download">Journal</a>
                            <div class="dropdown-menu" aria-labelledby="download">
                                <a class="dropdown-item" rel="noopener" target="_blank" href="https://jsfiddle.net/bootswatch/gh02neac/">Open in JSFiddle</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="../5/journal/bootstrap.css" download>bootstrap.css</a>
                                <a class="dropdown-item" href="../5/journal/bootstrap.min.css" download>bootstrap.min.css</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="../5/journal/bootstrap.rtl.css" download>bootstrap.rtl.css</a>
                                <a class="dropdown-item" href="../5/journal/bootstrap.rtl.min.css" download>bootstrap.rtl.min.css</a>
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="../5/journal/_variables.scss" download>_variables.scss</a>
                                <a class="dropdown-item" href="../5/journal/_bootswatch.scss" download>_bootswatch.scss</a>
                            </div>
                        </li>
                    </ul>
